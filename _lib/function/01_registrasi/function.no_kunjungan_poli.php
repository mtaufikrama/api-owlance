<?
require_once("../_lib/function/dbpoli.php");
...
function pasien_masuk($no_mr,$kode_bagian_masuk,$kode_dokter="",$tgl_masuk="",$stat_pasien="",$status_cito="0",$prioritas="",$keterangan="",$no_induk="",$asal_pasien="")
{
