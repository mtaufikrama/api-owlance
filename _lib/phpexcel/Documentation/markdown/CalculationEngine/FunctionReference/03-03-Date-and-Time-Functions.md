...
DATEVALUE uses the php date/time object implementation of strtotime2() (which can handle a wider range of formats than the normal strtotime2() function), and it is also called for any date parameter passed to other date functions (such as DATEDIF) when the parameter value is a string.
