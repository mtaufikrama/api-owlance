            ...
            switch ($rel["Type"]) {
                case "http://schemas.openxmlformats.org/package/2006/relationships/metadata/core-properties":
                    ...
                    if (is_object($xmlCore)) {
                        ...
                        $docProps->setCreated(strtotime2(self::getArrayItem($xmlCore->xpath("dcterms:created")))); //! respect xsi:type
                        $docProps->setModified(strtotime2(self::getArrayItem($xmlCore->xpath("dcterms:modified")))); //! respect xsi:type
