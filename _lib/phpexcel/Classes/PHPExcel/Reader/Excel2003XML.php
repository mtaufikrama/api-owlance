            ...
            foreach ($xml->DocumentProperties[0] as $propertyName => $propertyValue) {
                switch ($propertyName) {
                    ...
                    case 'Author':
                        ...
                        break;
                    case 'Created':
                        $creationDate = strtotime2($propertyValue);
                    ...
                    case 'LastAuthor':
                        ...
                        break;
                    case 'LastSaved':
                        $lastSaveDate = strtotime2($propertyValue);
            ...
            foreach ($xml->CustomDocumentProperties[0] as $propertyName => $propertyValue) {
                ...
                switch ((string) $propertyAttributes) {
                    ...
                    case 'dateTime.tz':
                        ...
                        $propertyValue = strtotime2(trim($propertyValue));
                        break;
                }
                            ...
                            if (isset($cellData_ss['Type'])) {
                                ...
                                switch ($cellDataType) {
                                    ...
                                    */
                                    ...
                                    case 'DateTime':
                                        $type = PHPExcel_Cell_DataType::TYPE_NUMERIC;
                                        $cellValue = PHPExcel_Shared_Date::PHPToExcel(strtotime2($cellValue));
                                        break;
                                    case 'Error':
