...
if (!class_exists("Tarif")) {
	class Tarif extends AvObjects {
		...
		private function _hitungTarifCurrent() {
			...
			$rTarif=read_tabel($view_tarif, "bill_rs, bill_dr1, bill_dr2, bill_dr3, kamar_tindakan, biaya_lain, obat, alkes, alat_rs, adm, overhead, bhp, pendapatan_rs, kode_master_tarif_detail, nama_tarif, jenis_tindakan,bill_perawat,bill_kjs,bill_bs_rs,bill_bs_dr,harga_dasar,gros_operator1,pendapatan_rsop,pendapatan_rsan,konsul,sewa_alat,ambhp,paramedis,sewa_kamar,observasi_ok", $optTarif);
