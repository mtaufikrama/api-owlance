			...
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-xl-12 col-lg-8">
						<div class="s-heading text-center mb-70">
							<h1 class="wow fadeInUp" data-wow-delay=".4s">Apa itu<font color="#4a90e2"> A-Dokter?</font></h1>
							<span class="wow fadeInUp" data-wow-delay=".2s"></span>
							<span class="wow fadeInUp" data-wow-delay=".2s">A-Dokter adalah system management klinik berbasis cloud yang mencakup seluruh perjalanan pasien mulai dari pendaftaran pasien dan penjadwalan janji temu sampai pasien pulang. A-Dokter telah dilengkapi dengan E-Registrasi, E-Medical Record dan E-Billing yang telah dispesialisasikan untuk pelayanan praktek dokter mandiri.</span>
						</div>
					</div>
				</div>
			</div>
		...
		<section class="services">
			...
			<div class="row">
				<div class="card col-lg-2 col-md-5 ">
					<div class="service-item mb-30">
						<div class="service-icon mb-25">
							<img src="assets/img/delivery/registrasi.png" alt="" style="height:70px ; width: 70px ;">
						</div>
				...
				<div class="card col-lg-2 col-md-6">
					<div class="service-item mb-30">
						<div class="service-icon mb-25">
							<img src="assets/img/delivery/edokter.png" alt="" style="height:70px ; width: 70px ;">
						</div>
						<div class="service-content">
							<h4>E-Dokter</h4>
				...
				<div class="card col-lg-2 col-md-6">
					<div class="service-item mb-30">
						<div class="service-icon mb-2">
							<img src="assets/img/delivery/ebilling.png" alt="" style="height:70px ; width: 70px ;">
						</div>
						<div class="service-content">
							<h4>E-Billing</h4>
							...
							<svg xmlns="http://www.w3.org/2000/svg" width="43.302" height="58.633" viewBox="0 0 43.302 58.633">
								<g id="noun_womb_1744327" transform="translate(-22.94 -12.449)">
									<path id="Path_81" data-name="Path 81"
										...
										transform="translate(-0.985 -4.655)" fill="#1BABF3" />
									...
									<path id="Path_83" data-name="Path 83"
										...
										transform="translate(-0.997 -4.602)" fill="#1BABF3" />
								</g>
							</svg>
						</div>
						<div class="service-content">
							...
							<svg id="noun_dental_care_2692540" data-name="noun_dental care_2692540" xmlns="http://www.w3.org/2000/svg"
								...
								<g id="Group_156" data-name="Group 156">
									...
									<path id="Path_85" data-name="Path 85"
										...
										transform="translate(-2.493 0)" fill="#1BABF3" />
								</g>
							</svg>
						</div>
						<div class="service-content">
		...
		<section id="received" class="about-section received-section pt-150">
			<div class="container">
				<div class="row align-items-center">
					<div class="col-lg-6">
						<div class="about-img received-img wow fadeInUp" data-wow-delay=".5s">
							<img src="assets/img/delivery/privy.png" alt="">
						</div>
					</div>
					<div class="col-lg-6">
						<div class="about-content received-content">
		...
		<section id="how" class="delivery-section pt-150">
			<div class="container">
				<div class="row align-items-center">
					...
					<div class="col-lg-7 order-first order-lg-last">
						<div class="delivery-img wow fadeInUp" data-wow-delay=".5s">
							<img src="assets/img/delivery/gambar6.jpg" alt="" style="height:500px ; width: 600px ;">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6">
					<div class="footer-widget wow fadeInUp" data-wow-delay=".6s">
						...
						<ul class="links">
							<li>
								<a href="javascript:void(0)">E-Registrasi</a>
							</li>
							<li>
								<a href="javascript:void(0)">E-Dokter</a>
							</li>
							<li>
								<a href="javascript:void(0)">E-Medical Record</a>
							</li>
							<li>
								<a href="javascript:void(0)">E-Resep</a>
							</li>
							<li>
								<a href="javascript:void(0)">E-Billing</a>
							</li>
						</ul>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-6">
					<div class="footer-widget wow fadeInUp" data-wow-delay=".8s">
						...
						<ul class="links">
							<li>
								<a href="javascript:void(0)">Low-Investment</a>
							</li>
							<li>
								<a href="javascript:void(0)">User Friendly</a>
							</li>
							<li>
								<a href="javascript:void(0)">Standardized</a>
							</li>
							<li>
								<a href="javascript:void(0)">Mobile Integration</a>
							</li>
						</ul>
					</div>
				</div>
