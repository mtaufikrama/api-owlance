...
//kode_dokter, tgl_daftar, tgl_skrng

//----------------------------------------------------------------------------------------------//
$TglSkrg=date("Y-m-d", strtotime($tgl_skrng));
...
$TglSkrg=date("H:i:s", strtotime($tgl_skrng));
...
$jam_sekarang=$TglSkrg=date("H:i:s", strtotime($tgl_skrng));

if(strtotime($tgl_daftar) == strtotime(date("Y-m-d"))){
	if(strtotime($jam_mulai)<strtotime($jam_sekarang)){
		$jeda=strtotime($tgl_skrng) - strtotime(date("H:i:s",strtotime($jam_mulai)));// Jam Sekarang - Jam Mulai
