...
?>
	...
	<div class="tab-page" id="tab_credits">
		...
		<!-- hhmts start -->
		<pre>
		Last modified: $Date: 2004/02/21 19:30:26 $
		Revision: $Revision: 1.2.2.13 $
		</pre>
	</div>
	<div class="tab-page" id="tab_links">
		<h2 class="tab">Links</h2>
		<ul>
			<li><a href="http://www.phpdoc.org/manual.php">phpDocumentor manual</a> - Learn how to use phpDocumentor to document your PHP source code</li>
			<li><a href="http://phpdocu.sourceforge.net/">phpDocumentor homepage</a> on SourceForge</li>
			<li><a href="http://freshmeat.net/projects/phpdocu">Freshmeat record</a> - subscribe here</li>
		</ul>
	</div>
</div>
