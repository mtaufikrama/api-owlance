...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'rawurlencode', 'method.tpl', 4, false),)), $this); ?>
<?php ob_start();  if ($this->_tpl_vars['constructor']): ?>Constructor <?php else: ?>Method <?php endif;  echo $this->_tpl_vars['intricatefunctioncall']['name'];  $this->_smarty_vars['capture']['mlink'] = ob_get_contents(); ob_end_clean(); ?>
<?php ob_start();  if ($this->_tpl_vars['constructor']): ?>constructor <?php endif;  echo $this->_tpl_vars['class']; ?>
::<?php echo $this->_tpl_vars['intricatefunctioncall']['name']; ?>
()|||<?php echo $this->_tpl_vars['sdesc'];  $this->_smarty_vars['capture']['mindex'] = ob_get_contents(); ob_end_clean(); ?>
<pdffunction:addDestination arg="<?php echo $this->_tpl_vars['dest']; ?>
" arg="FitH" arg=$this->y />
<text size="10" justification="left"><?php if ($this->_tpl_vars['constructor']): ?>Constructor <?php else:  endif; ?><i><?php echo $this->_tpl_vars['return']; ?>
...
]<?php endif;  endfor; endif; ?>) <i>[line <?php if ($this->_tpl_vars['slink']):  echo $this->_tpl_vars['slink'];  else:  echo $this->_tpl_vars['linenumber'];  endif; ?>]</i><C:rf:3<?php echo ((is_array($_tmp=$this->_smarty_vars['capture']['mlink'])) ? $this->_run_mod_handler('rawurlencode', true, $_tmp) : smarty_modifier_rawurlencode($_tmp)); ?>
><C:index:<?php echo ((is_array($_tmp=$this->_smarty_vars['capture']['mindex'])) ? $this->_run_mod_handler('rawurlencode', true, $_tmp) : smarty_modifier_rawurlencode($_tmp)); ?>
></text>