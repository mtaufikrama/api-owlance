...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'rawurlencode', 'var.tpl', 6, false),)), $this); ?>
<?php ob_start(); ?>Var <?php echo $this->_tpl_vars['name'];  $this->_smarty_vars['capture']['vlink'] = ob_get_contents(); ob_end_clean(); ?>
