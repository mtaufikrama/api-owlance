<?php /* Smarty version 2.6.0, created on 2003-12-18 01:18:38
...
?>
    <?php if ($this->_tpl_vars['subpackage'] != ""): ?>&nbsp;&nbsp;<?php endif; ?>
...
"><?php endif;  echo $this->_tpl_vars['files'][$this->_sections['files']['index']]['title'];  if ($this->_tpl_vars['files'][$this->_sections['files']['index']]['link'] != ''): ?></a><?php endif; ?><br />
	<?php endfor; endif; ?>
  </div>
