...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'class.tpl', 15, false),)), $this); ?>
...
<div class="leftcol">
	<h3><a href="#class_details"><?php if ($this->_tpl_vars['is_interface']): ?>Interface<?php else: ?>Class<?php endif; ?> Overview</a> <span class="smalllinenumber">[line <?php if ($this->_tpl_vars['class_slink']):  echo $this->_tpl_vars['class_slink'];  else:  echo $this->_tpl_vars['line_number'];  endif; ?>]</span></h3>
...
$this->_sections['tree']['last']       = ($this->_sections['tree']['iteration'] == $this->_sections['tree']['total']);
 echo $this->_tpl_vars['class_tree']['classes'][$this->_sections['tree']['index']];  echo $this->_tpl_vars['class_tree']['distance'][$this->_sections['tree']['index']];  endfor; endif; ?></pre>
	...
	<div class="small">
	<p><?php echo ((is_array($_tmp=@$this->_tpl_vars['sdesc'])) ? $this->_run_mod_handler('default', true, $_tmp, '') : smarty_modifier_default($_tmp, '')); ?>
</p>
...
?>
		<div class="indent">
		<h3>Class: <?php echo $this->_tpl_vars['iconsts'][$this->_sections['iconsts']['index']]['parent_class']; ?>
</h3>
		<div class="small">
			<dl>
