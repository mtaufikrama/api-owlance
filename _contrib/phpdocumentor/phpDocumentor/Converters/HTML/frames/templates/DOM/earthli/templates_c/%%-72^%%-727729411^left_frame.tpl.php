<?php /* Smarty version 2.6.0, created on 2003-12-18 01:11:07
         compiled from left_frame.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip_tags', 'left_frame.tpl', 122, false),)), $this); ?>
...
');
	...
	<?php else: ?>
		<?php if ($this->_tpl_vars['info'][$this->_sections['p']['index']]['subpackagetutorial']): ?>
			var subpackagetree = new WebFXTreeItem('<span class="sub-package"><?php echo ((is_array($_tmp=$this->_tpl_vars['info'][$this->_sections['p']['index']]['subpackagetutorialtitle'])) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)); ?>
