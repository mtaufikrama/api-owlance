<?php /* Smarty version 2.6.0, created on 2003-12-18 01:00:45
...
$this->_sections['iconsts2']['loop'] = is_array($_loop=$this->_tpl_vars['iconsts2'][$this->_sections['iconsts2']['index']]['iconsts']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
