<?php /* Smarty version 2.6.0, created on 2003-12-18 01:02:18
...
<thead>
  <tr>
    <td><strong><?php echo $this->_tpl_vars['index'][$this->_sections['index']['index']]['letter']; ?>
</strong></td>
    <td align='right'><a name="<?php echo $this->_tpl_vars['index'][$this->_sections['index']['index']]['letter']; ?>
">&nbsp; </a>
...
?>
  <tr>
    <td>&nbsp;&nbsp;&nbsp;<strong><?php echo $this->_tpl_vars['index'][$this->_sections['index']['index']]['index'][$this->_sections['contents']['index']]['name']; ?>
</strong></td>
    <td width="100%" align="left" valign="top"><?php echo $this->_tpl_vars['index'][$this->_sections['index']['index']]['index'][$this->_sections['contents']['index']]['listing']; ?>
</td>
  </tr>
  <?php endfor; endif; ?>
</tbody>
